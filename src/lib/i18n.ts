...
const de = {
  ...
  "orders.subtitle":
    "Erfasse, was bestellt werden muss – die Verantwortlichen haken es hier ab.",
  "orders.new": "Neue Bestellung",
  "orders.newButton": "+ Neue Bestellung",
  "orders.create": "Bestellung erstellen",
  "orders.category": "Kategorie",
  "orders.chooseCategory": "Kategorie wählen…",
  "orders.items": "Artikel",
  "orders.qty": "Anzahl",
  "orders.itemPlaceholder": "z. B. Gw Pat 90",
  "orders.addItem": "+ Artikel hinzufügen",
  "orders.removeItem": "Artikel entfernen",
  "orders.descPlaceholder": "Details: Ort, Bemerkungen (optional)…",
  "orders.neededBy": "Wird benötigt am",
  "orders.neededLabel": "Benötigt am: {datetime}",
  "orders.orderedBy": "Bestellt von {name} am {date}",
  "orders.completedBy": "Erledigt von {name} am {date}",
  "orders.done": "Erledigt",
  "orders.overdue": "Überfällig",
  "orders.markDone": "Als erledigt markieren",
  "orders.markOpen": "Wieder öffnen",
  ...
  "cat.platz": "Platz",
  "cat.zwipf": "Zwipf",
  "err.orderCatReq": "Bitte eine Kategorie wählen.",
  "err.orderItems":
    "Mindestens ein Artikel mit Anzahl und Name ist erforderlich.",
  "err.orderDueReq": "Datum und Zeit sind erforderlich.",
  ...
  "err.adminOnly": "Nur Admins können das ändern.",
...
const fr = {
  ...
  "orders.subtitle":
    "Saisis ce qui doit être commandé – les responsables le cochent ici.",
  "orders.new": "Nouvelle commande",
  "orders.newButton": "+ Nouvelle commande",
  "orders.create": "Créer la commande",
  "orders.category": "Catégorie",
  "orders.chooseCategory": "Choisir une catégorie…",
  "orders.items": "Articles",
  "orders.qty": "Quantité",
  "orders.itemPlaceholder": "p. ex. cartouches F ass 90",
  "orders.addItem": "+ Ajouter un article",
  "orders.removeItem": "Supprimer l’article",
  "orders.descPlaceholder": "Détails : lieu, remarques (facultatif)…",
  "orders.neededBy": "Nécessaire le",
  "orders.neededLabel": "Nécessaire le : {datetime}",
  "orders.orderedBy": "Commandé par {name} le {date}",
  "orders.completedBy": "Terminé par {name} le {date}",
  "orders.done": "Terminée",
  "orders.overdue": "En retard",
  "orders.markDone": "Marquer comme terminée",
  "orders.markOpen": "Rouvrir",
  ...
  "cat.platz": "Place",
  "cat.zwipf": "Zwipf",
  "err.orderCatReq": "Veuillez choisir une catégorie.",
  "err.orderItems": "Au moins un article avec quantité et nom est requis.",
  "err.orderDueReq": "La date et l’heure sont obligatoires.",
  ...
  "err.adminOnly": "Seuls les admins peuvent modifier cela.",
